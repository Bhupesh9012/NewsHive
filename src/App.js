  ...
  render() {
    return (
      <div>
        ...
        <Navbar/>
        <Routes>
        <Route exact path="/" element={<News key="buisness" pageSize={this.pageSize} country="us" category="business" />}/>
        <Route exact path="/business" element={<News key="buisness" pageSize={this.pageSize} country="us" category="business" />}/>
