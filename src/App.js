  ...
  render() {
    return (
      <div>
        ...
        <Navbar/>
        <Routes>
        <Route exact path="/" element={<News key="buisness" pageSize={6} country="us" category="business" />}/>
        <Route exact path="/business" element={<News key="buisness" pageSize={6} country="us" category="business" />}/>
