  ...
  render() {
    return (
      ...
      />
        ...
        <Routes>
        <Route exact path="/" element={<News setProgress={this.setProgress} key="buisness" pageSize={this.pageSize} country="us" category="business" />}/>
        <Route exact path="/business" element={<News setProgress={this.setProgress} key="buisness" pageSize={this.pageSize} country="us" category="business" />}/>
